...
function Register() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (
      !USER_REGEX.test(formValue.user) ||
      !PWD_REGEX.test(formValue.password)
    ) {
      ...
      {success ? (
        ...
        <section>
          ...
          <form onSubmit={handleSubmit}>
            <label htmlFor="user">
              username:
              <span className={valid.user ? "valid" : "hide"}>
                <FontAwesomeIcon icon={faCheck} />
              </span>
              <span
                className={valid.user || !formValue.user ? "hide" : "invalid"}
              >
            ...
            <p
              id="uidnote"
              className={
                focusUser.user && formValue.user && !valid.user
                  ? "instructions"
                  : "offscreen"
              }
            >
            ...
            <label htmlFor="password">
              ...
              <FontAwesomeIcon
                icon={faCheck}
                className={valid.password ? "valid" : "hide"}
              />
              <FontAwesomeIcon
                icon={faTimes}
                className={
                  valid.password || !formValue.password ? "hide" : "invalid"
                }
              />
            </label>
            <input
            ...
            <p
              id="pwdnote"
              className={
                focusUser.password && !valid.password
                  ? "instructions"
                  : "offscreen"
              }
            >
            ...
            <label htmlFor="confirm_pwd">
              ...
              <FontAwesomeIcon
                icon={faCheck}
                className={
                  valid.matchPwd && formValue.matchPwd ? "valid" : "hide"
                }
              />
              <FontAwesomeIcon
                icon={faTimes}
                className={
                  valid.matchPwd || !formValue.matchPwd ? "hide" : "invalid"
                }
              />
            </label>
            <input
            ...
            <p
              id="confirmnote"
              className={
                focusUser.matchPwd && !valid.matchPwd
                  ? "instructions"
                  : "offscreen"
              }
            >
            ...
            <button
              disabled={
                !valid.user || !valid.password || !valid.matchPwd
                  ? false
                  : false
              }
            >
